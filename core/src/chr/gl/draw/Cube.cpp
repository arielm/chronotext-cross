...
namespace chr
{
  namespace gl
  {
    namespace draw
    {
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ, GLuint> &batch, const Matrix &matrix) const
      {
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ.N, GLuint> &batch, const Matrix &matrix) const
      {
        float unit = size * 0.5f;
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ.UV, GLuint> &batch, const Matrix &matrix) const
      {
        float unit = size * 0.5f;
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ.RGBA, GLuint> &batch, const Matrix &matrix) const
      {
        float unit = size * 0.5f;
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ.N.UV, GLuint> &batch, const Matrix &matrix) const
      {
        float unit = size * 0.5f;
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ.N.RGBA, GLuint> &batch, const Matrix &matrix) const
      {
        float unit = size * 0.5f;
      ...
      template <>
      void Cube::append(IndexedVertexBatch<XYZ.N.UV.RGBA, GLuint> &batch, const Matrix &matrix) const
      {
        float unit = size * 0.5f;
        ...
        // FRONT
        batch
          .addVertex(matrix.transformPoint(-unit, -unit, +unit), normal0, glm::vec2(0, 0), color0)
          .addVertex(matrix.transformPoint(+unit, -unit, +unit), normal0, glm::vec2(1, 0), color0)
          .addVertex(matrix.transformPoint(+unit, +unit, +unit), normal0, glm::vec2(1, 1), color0)
          .addVertex(matrix.transformPoint(-unit, +unit, +unit), normal0, glm::vec2(0, 1), color0);

        // BACK
        batch
          .addVertex(matrix.transformPoint(-unit, -unit, -unit), normal1, glm::vec2(0, 0), color1)
          .addVertex(matrix.transformPoint(-unit, +unit, -unit), normal1, glm::vec2(1, 0), color1)
          .addVertex(matrix.transformPoint(+unit, +unit, -unit), normal1, glm::vec2(1, 1), color1)
          .addVertex(matrix.transformPoint(+unit, -unit, -unit), normal1, glm::vec2(0, 1), color1);

        // TOP
        batch
          .addVertex(matrix.transformPoint(-unit, +unit, -unit), normal2, glm::vec2(0, 0), color2)
          .addVertex(matrix.transformPoint(-unit, +unit, +unit), normal2, glm::vec2(1, 0), color2)
          .addVertex(matrix.transformPoint(+unit, +unit, +unit), normal2, glm::vec2(1, 1), color2)
          .addVertex(matrix.transformPoint(+unit, +unit, -unit), normal2, glm::vec2(0, 1), color2);

        // BOTTOM
        batch
          .addVertex(matrix.transformPoint(-unit, -unit, -unit), normal3, glm::vec2(0, 0), color3)
          .addVertex(matrix.transformPoint(+unit, -unit, -unit), normal3, glm::vec2(1, 0), color3)
          .addVertex(matrix.transformPoint(+unit, -unit, +unit), normal3, glm::vec2(1, 1), color3)
          .addVertex(matrix.transformPoint(-unit, -unit, +unit), normal3, glm::vec2(0, 1), color3);

        // RIGHT
        batch
          .addVertex(matrix.transformPoint(+unit, -unit, -unit), normal4, glm::vec2(0, 0), color4)
          .addVertex(matrix.transformPoint(+unit, +unit, -unit), normal4, glm::vec2(1, 0), color4)
          .addVertex(matrix.transformPoint(+unit, +unit, +unit), normal4, glm::vec2(1, 1), color4)
          .addVertex(matrix.transformPoint(+unit, -unit, +unit), normal4, glm::vec2(0, 1), color4);

        // LEFT
        batch
          .addVertex(matrix.transformPoint(-unit, -unit, -unit), normal5, glm::vec2(0, 0), color5)
          .addVertex(matrix.transformPoint(-unit, -unit, +unit), normal5, glm::vec2(1, 0), color5)
          .addVertex(matrix.transformPoint(-unit, +unit, +unit), normal5, glm::vec2(1, 1), color5)
          .addVertex(matrix.transformPoint(-unit, +unit, -unit), normal5, glm::vec2(0, 1), color5);
