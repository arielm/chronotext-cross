  ...
  namespace gl
  {
    namespace draw
    {
      ...
      public:
        ...
        {
          fill<Orientation>(batch, matrix, x - batch.texture.innerWidth * 0.5f, y - batch.texture.innerHeight * 0.5f);
        }
        ...
        {
          fill<Orientation>(batch, x - batch.texture.innerWidth * 0.5f, y - batch.texture.innerHeight * 0.5f);
        }
