...
elseif (PLATFORM MATCHES osx)
  if (RUN MATCHES EXE)
    ...
    if (DEFINED SUDO)
      set(CONFIG_RUN "${CROSS_ROOT}/cmake/osx/run.sudo.sh.in")
    else()
...
elseif (PLATFORM MATCHES rpi|rpi64|linux)
  if (RUN MATCHES EXE)
    ...
    if (DEFINED SUDO)
      set(CONFIG_RUN "${CROSS_ROOT}/cmake/${PLATFORM}/run.sudo.sh.in")
    else()
      set(CONFIG_RUN "${CROSS_ROOT}/cmake/${PLATFORM}/run.sh.in")
    endif()
