...
set(PNG16_ROOT "$ENV{CROSS_PATH}/tree/libpng16")
...
elseif (PLATFORM MATCHES android|android64)
  list(APPEND INCLUDE_DIRS "${PNG16_ROOT}/android/include")
  list(APPEND LIBRARIES "${PNG16_ROOT}/android/${ANDROID_ABI}/libpng16.a")

else()
  list(APPEND INCLUDE_DIRS "${PNG16_ROOT}/${PLATFORM}/include")
  list(APPEND LIBRARIES "${PNG16_ROOT}/${PLATFORM}/lib/libpng16.a")
endif()
